...
insert into Categories(Uid, Name, Description, CreatedAt)
values ('bf9dfa9a-da2e-423c-b145-b84b62497909', 'Lanches', 'Os mais deliciosos lanches da região.', GETDATE());
...
insert into Category(Uid, Name, Description, CreatedAt)
values ('96153509-b6ce-46f8-aac1-d135d2a2c37a', 'Sobremesas', 'Para finalizar sua experiência.', GETDATE());
